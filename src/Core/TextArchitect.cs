...
public class TextArchitect
{
    ...
    //Renew this architext by giving it a new target display, overriding the old one. Allows the same architect to be used multiple 
    //times rather than creating a new one
